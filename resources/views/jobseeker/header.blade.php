    ...
    <nav class="nav container">
        <div class="nav__data">
            <a href="#" class="nav__logo">
                <img src="import/images/PESO LOGO NEW.png" width="50px;">
        ...
        <div class="nav__menu" id="nav-menu">
            <ul class="nav__list">
                <li><a href="jobseeker.blade.php" class="nav__link">Home</a></li>
                ...
                <li><a href="{{ url('/dashboard') }}" class="nav__link">Dashboard</a></li>
