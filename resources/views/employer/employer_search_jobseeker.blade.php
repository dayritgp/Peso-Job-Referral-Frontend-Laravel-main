<!DOCTYPE html>
   ...
   <head>
      ...
      <link rel="stylesheet" href="{{asset('import/css/employer_search_jobseeker.css')}}">
    ...
    <header class="header" id="header">
        <nav class="nav container">
         ...
         <div id="jobs" class="container" style="padding-top: 40px;">
            <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Find Job Seekers</h1>
            <h3><center>Search by Position Title, Employer Name, Work Location, Education Level, or Course, etc.</center></h3><br>
           
        </div>
        
        <div class="tablemax">
        <table class="job-table" id="dashboardjobs">
         <thead>
             <tr>
                 <th>Job Seeker</th>
             </tr>
                 ...
                 <td class="job-cell job-details">
                     <div class = "side-by-side" >
                        ...
                        <div class = "display1">
                         ...
                         <div class = "display2"> 
                            <div class="job-title">Hannah Montana <a href="../../view/employer/employer_view_profile.html">
                                    <button class="btn-view-prof"><i class="fas fa-eye"></i>View Profile</button></a></div>
                                <div class="task">Job Preferrence: Programmer, Web Developer</div>
                                <div class="company">23 years old</div>
                                <div class="location"><i class="fas fa-map-marker-alt"></i> Eusebio Bulaong Ave., General Santos City</div>
                                <div class="salary"><i class="fas fa-money-bill-alt"></i>Unemployed</div>
                                <div class="description">We are looking for a talented software engineer to join our team...</div>
                                <div class="buttons-container">
                                    <a href="#"><button class="job-button">Calendar Management: 3 years experience</button></a>
                                    <a href="#"><button class="job-button">Email Management: 2 years experience</button></a>
                                    <a href="#"><button class="job-button">Travel Planning</button></a>
