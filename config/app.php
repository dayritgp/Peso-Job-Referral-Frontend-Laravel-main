...
return [
    ...
    */
    ...
    'url_local' => env('APP_URL_LOCAL', 'http://localhost/peso_referral/public'),
    ...
    */
    ...
    'maintenance' => [
        ...
        /*
    |--------------------------------------------------------------------------
    | Application HTTP URL and Directory
    |--------------------------------------------------------------------------
    |
    | This value is the http based URL and directory
    |
    */

    'app_http_url' => env('APP_HTTP_URL'),
    'app_http_url_dir' => env('APP_HTTP_URL_DIR'),
